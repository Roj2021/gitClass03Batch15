...
public class VariablesDemo_1 {
    public static void main(String[] args) {
        ...
        salary=120000; // updating variable or reassign a value.
        System.out.println(salary);

        String name,city,country; //we can create multiple empty boxes in a single line of code
        char gender,letter;
        name="Daria"; //storing  avlue in the variable
       // System.out.println(city);// I have not stored anything inside the city variable that's why java confused.
        //what to print
